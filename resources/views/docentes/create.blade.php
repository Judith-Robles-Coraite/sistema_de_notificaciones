    ...
    <form action="{{route('docentes.store')}}" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" name ="id_usuario"  class="form-control @error('id_usuario') is-invalid @enderror" value = "{{old('id_usuario')}}" readonly onmousedown="return false;" >
        ...
        <div class="form-group">
            ...
            <div class="form-check  ">
                <input type="radio" class="form-check-input @error('id_genero') is-invalid @enderror" name="id_genero" value="{{old('1')}}" /> 
                <label class="form-check-label" >Maculino</label>
                <br>
                <input type="radio" class="form-check-input @error('id_genero') is-invalid @enderror" name="id_genero" value="{{old('2')}}" />
